            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm opacity-90">
                  <li className="hover:text-green-200 transition-colors cursor-pointer">Environmental Monitoring</li>
                  <li className="hover:text-green-200 transition-colors cursor-pointer">Urban Growth Analysis</li>
                  <li className="hover:text-green-200 transition-colors cursor-pointer">Climate Risk Assessment</li>
